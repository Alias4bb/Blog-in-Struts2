...
<meta name="description" content="My Static Blog in Hexo&J2EE" />
 <meta name="keywords" content="Hexo,next,J2EE" />
...
<nav class="site-nav">
    ...
    <main id="main" class="main">
        <div class="main-inner">
            ...
            <% Db db=new Db();
            ResultSet rs;
            String sql="select * from blog_contents";
            rs=db.doSelect(sql);
            while(rs.next()){
             %>
  <section id="posts" class="posts-expand">
    ...
    <header class="post-header">
        ...
        <h1 class="post-title" itemprop="name headline">
              ...
              <a class="post-title-link" href="Posts?id=<%=rs.getString("c_id") %>" itemprop="url">
        ...
        <span class="post-time">
          ...
          <span class="post-category" >
            &nbsp; | &nbsp; 分类于
              ...
              <span itemprop="about" itemscope itemtype="https://schema.org/Thing"><a href="Categories?type=<%=rs.getString("c_type") %>" itemprop="url" rel="index">
              <span itemprop="name"><%=rs.getString("c_type") %></span></a></span>
