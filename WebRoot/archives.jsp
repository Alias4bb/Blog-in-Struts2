...
<nav class="site-nav">
  ...
  <section id="posts" class="posts-collapse">
    ...
    <span class="archive-page-counter">
      ...
      int cc_count=0;
        ResultSet rs;
        String sql="select count(*) from blog_contents";
        rs=db.doSelect(sql);
        if(rs.next()){
     ...
     非常好! 目前共计<%=cc_count %> 篇日志。 继续努力。
      ...
      <% String sql3="select * from blog_contents";
        rs=db.doSelect(sql3);
        while(rs.next()){
      %>
...
<%     
  ...
  %>
      <div class="post-meta">
        <time class="post-time" > <%=date1 %> </time>
      </div>
